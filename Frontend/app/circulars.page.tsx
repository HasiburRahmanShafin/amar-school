...
export default function ManageCircularsPage() {
  ...
  const toggleStatus = async (c: AdmissionCircular) => {
  ...
  const inputClass =
    'w-full border border-blue-200 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500';
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="bg-blue-700 text-white font-medium px-5 py-2.5 rounded-lg hover:bg-blue-800 transition-colors"
          >
        ...
        {showForm && (
          <form
            ...
            className="bg-white border border-blue-100 rounded-xl p-6 mb-8 space-y-4 shadow-sm"
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setForm({ ...form, classOrGrade: e.target.value })}
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input
                className={inputClass}
                placeholder="Birth certificate, Previous report card"
            ...
            <button
              type="submit"
              className="bg-blue-700 text-white font-medium px-6 py-2.5 rounded-lg hover:bg-blue-800 transition-colors"
            >
              Create circular
            </button>
          </form>
        ...
        <div className="grid gap-3">
          {circulars.map((c) => (
            <div
              key={c._id}
              className="bg-white border border-blue-100 rounded-xl p-5 flex items-center justify-between"
            >
              <div>
                <h3 className="font-semibold text-blue-900">{c.title}</h3>
                <p className="text-sm text-gray-500">
                  {c.classOrGrade} · {c.totalSeats} seats · Deadline{' '}
