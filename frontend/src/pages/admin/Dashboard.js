  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link to="/admin/school-profile" className="bg-white rounded shadow p-5 hover:shadow-md transition">
          <h3 className="font-semibold mb-1">School Profile</h3>
          <p className="text-sm text-gray-500">
            Institution identity, EIIN, leadership, contact info, address, and social media.
          </p>
        </Link>
