        ...
        <section className="bg-white rounded shadow p-6 mt-6 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="text-sm text-gray-600 space-y-2">
              {school.eiin && <p><strong>EIIN:</strong> {school.eiin}</p>}
              <p><strong>Address:</strong> {school.address}</p>
              <p>
                <strong>Phone:</strong> {[school.phone, ...(school.additionalPhones || [])].filter(Boolean).join(', ')}
              </p>
              <p>
                <strong>Email:</strong> {[school.email, ...(school.additionalEmails || [])].filter(Boolean).join(', ')}
              </p>
