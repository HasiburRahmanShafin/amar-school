...
const icons = {
  ...
  exam:        <><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><path d="M9 7h6"/><path d="M9 11h6"/></>,
  results:     <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></>,
  marks:       <><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></>,
  ...
  changes:     <><path d="M12 2a10 10 0 100 20 10 10 0 000-20z"/><path d="M12 6v6l4 2"/></>,
};
...
const NAV_ITEMS = {
  school_admin: [
    ...
    { label: 'Exam Schedules',  to: '/admin/exams',                     icon: 'exam'       },
    { label: 'Result Management', to: '/admin/results',                 icon: 'results'    },
  ...
  student: [
    ...
    { label: 'Academic Results', to: '/student/results',      icon: 'results'   },
  ],
  parent: [
    { label: 'Exam Routine',     to: '/student/exam-routine', icon: 'exam'      },
    { label: 'Academic Results', to: '/student/results',      icon: 'results'   },
  ...
  super_admin: [
    ...
    { label: 'Profile Change Requests', to: '/superadmin/profile-changes', icon: 'changes' },
  ],
};
