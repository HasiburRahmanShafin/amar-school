...
const NAV_ITEMS = {
  school_admin: [
    ...
    { label: 'School Profile',  to: '/admin/school-profile',            icon: 'profile'    },
    { label: 'Fee Management',  to: '/admin/fees',                      icon: 'fees'       },
  ],
  teacher: [
    { label: 'Dashboard',        to: '/teacher/dashboard',   icon: 'dashboard'  },
    { label: 'Take Attendance',  to: '/teacher/attendance',  icon: 'attendance' },
    { label: 'My Profile',       to: '/teacher/profile',     icon: 'profile'    },
  ],
  student: [
    { label: 'Dashboard',          to: '/student/dashboard',   icon: 'dashboard'  },
    { label: 'Attendance History', to: '/student/attendance',  icon: 'attendance' },
    { label: 'Fee Payment',        to: '/student/fees',        icon: 'fees'       },
  ],
  super_admin: [
    { label: 'Schools',         to: '/superadmin/schools',          icon: 'schools' },
    { label: 'Profile Changes', to: '/superadmin/profile-changes',  icon: 'profile' },
  ],
};
