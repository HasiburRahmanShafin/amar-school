...
exports.getCirculars = async (req, res) => {
  try {
    ...
    if (req.query.subdomain) {
      ...
      // Admin panel calls this without any query param - default to the
      // logged-in admin's own school so they never see (or manage) another
      // school's circulars/applicant counts.
